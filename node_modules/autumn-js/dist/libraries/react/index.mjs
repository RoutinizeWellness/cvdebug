...
function createSlot2(ownerName) {
  ...
  const Slot22 = React14.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return /* @__PURE__ */ jsx11(SlotClone, { ...slotProps, ref: forwardedRef, children: React14.isValidElement(newElement) ? React14.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var Portal = React20.forwardRef((props, forwardedRef) => {
  ...
  return container ? ReactDOM2.createPortal(/* @__PURE__ */ jsx15(Primitive.div, { ...portalProps, ref: forwardedRef }), container) : null;
});
...
var DialogPortal = (props) => {
  ...
  return /* @__PURE__ */ jsx16(PortalProvider, { scope: __scopeDialog, forceMount, children: React32.Children.map(children, (child) => /* @__PURE__ */ jsx16(Presence, { present: forceMount || context.open, children: /* @__PURE__ */ jsx16(Portal, { asChild: true, container, children: child }) })) });
};
...
var DialogOverlayImpl = React32.forwardRef(
  (props, forwardedRef) => {
    ...
    return (
      ...
      /* @__PURE__ */ jsx16(Combination_default, { as: Slot2, allowPinchZoom: true, shards: [context.contentRef], children: /* @__PURE__ */ jsx16(
        Primitive.div,
        {
          "data-state": getState3(context.open),
          ...overlayProps,
...
var DialogContentImpl = React32.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsxs3(Fragment6, { children: [
      ...
      /* @__PURE__ */ jsxs3(Fragment6, { children: [
...
var DialogPortal2 = ({
  ...
  return /* @__PURE__ */ jsx17(Portal2, { ...props, children: /* @__PURE__ */ jsx17("div", { className: "au-root", children }) });
};
var DialogOverlay2 = React33.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx17(
  Overlay,
  {
    ref,
    className: cn(
    ...
    Content3,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs4(Close, { className: "au-absolute au-right-4 au-top-4 au-rounded-sm au-opacity-70 au-ring-offset-background au-transition-opacity hover:au-opacity-100 focus:au-outline-none focus:au-ring-2 focus:au-ring-ring focus:au-ring-offset-2 disabled:au-pointer-events-none data-[state=open]:au-bg-accent data-[state=open]:au-text-muted-foreground", children: [
          /* @__PURE__ */ jsx17(X, { className: "au-h-4 au-w-4" }),
          /* @__PURE__ */ jsx17("span", { className: "au-sr-only", children: "Close" })
        ] })
      ]
    }
  )
...
var DialogTitle2 = React33.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx17(
  Title,
  {
    ref,
    className: cn(
...
var DialogDescription2 = React33.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx17(
  Description,
  {
    ref,
...
var Popover = (props) => {
  ...
  return /* @__PURE__ */ jsx21(Root22, { ...popperScope, children: /* @__PURE__ */ jsx21(
    PopoverProvider,
    {
...
var PopoverTrigger = React39.forwardRef(
  (props, forwardedRef) => {
    ...
    return context.hasCustomAnchor ? trigger : /* @__PURE__ */ jsx21(Anchor, { asChild: true, ...popperScope, children: trigger });
  }
);
...
var PopoverPortal = (props) => {
  ...
  return /* @__PURE__ */ jsx21(PortalProvider2, { scope: __scopePopover, forceMount, children: /* @__PURE__ */ jsx21(Presence, { present: forceMount || context.open, children: /* @__PURE__ */ jsx21(Portal, { asChild: true, container, children }) }) });
};
...
var PopoverContent = React39.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsx21(Presence, { present: forceMount || context.open, children: context.modal ? /* @__PURE__ */ jsx21(PopoverContentModal, { ...contentProps, ref: forwardedRef }) : /* @__PURE__ */ jsx21(PopoverContentNonModal, { ...contentProps, ref: forwardedRef }) });
  }
);
...
var PopoverContentModal = React39.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsx21(Combination_default, { as: Slot3, allowPinchZoom: true, children: /* @__PURE__ */ jsx21(
      PopoverContentImpl,
      {
        ...props,
        ref: composedRefs,
...
var PopoverContent2 = React40.forwardRef(({ className, align = "center", sideOffset = 4, ...props }, ref) => /* @__PURE__ */ jsx23(
  Content22,
  {
    ref,
    align,
...
var getCheckoutContent = (checkoutResult) => {
  ...
  if (scenario == "active" && updateable) {
    if (updateable) {
      return {
        title: /* @__PURE__ */ jsx24("p", { children: "Update Plan" }),
        message: /* @__PURE__ */ jsx24("p", { children: "Update your prepaid quantity. You'll be charged or credited the prorated difference based on your current billing cycle." })
      };
    }
  }
  if (has_trial) {
  ...
  switch (scenario) {
    ...
    case "active":
      return {
        title: /* @__PURE__ */ jsx24("p", { children: "Product already active" }),
        message: /* @__PURE__ */ jsx24("p", { children: "You are already subscribed to this product." })
      };
    case "new":
      if (is_free) {
        return {
    ...
    case "renew":
      return {
        title: /* @__PURE__ */ jsx24("p", { children: "Renew" }),
        message: /* @__PURE__ */ jsxs5("p", { children: [
    ...
    case "cancel":
      return {
        title: /* @__PURE__ */ jsx24("p", { children: "Cancel" }),
        message: /* @__PURE__ */ jsxs5("p", { children: [
    ...
    default:
      return {
        title: /* @__PURE__ */ jsx24("p", { children: "Change Subscription" }),
        message: /* @__PURE__ */ jsx24("p", { children: "You are about to change your subscription." })
      };
  }
};

// src/libraries/react/components/checkout-dialog/checkout-dialog-synced.tsx
import { Fragment as Fragment7, jsx as jsx25, jsxs as jsxs6 } from "react/jsx-runtime";
var formatCurrency = ({
  amount,
  currency
}) => {
...
function CheckoutDialog(params) {
  ...
  return /* @__PURE__ */ jsx25(Dialog2, { open, onOpenChange: setOpen, children: /* @__PURE__ */ jsxs6(DialogContent2, { className: "au-p-0 au-pt-4 au-gap-0 au-text-foreground au-text-sm", children: [
    /* @__PURE__ */ jsx25(DialogTitle2, { className: "au-px-6 au-mb-1", children: title }),
    /* @__PURE__ */ jsx25("div", { className: "au-px-6 au-mt-1 au-mb-4 au-text-muted-foreground", children: message }),
    isPaid && checkoutResult && /* @__PURE__ */ jsx25(
      PriceInformation,
      {
        checkoutResult,
        setCheckoutResult
    ...
    /* @__PURE__ */ jsx25(DialogFooter, { className: "au-flex au-flex-col sm:au-flex-row au-justify-between au-gap-x-4 au-py-2 au-pl-6 au-pr-3 au-bg-secondary au-border-t au-shadow-inner", children: /* @__PURE__ */ jsx25(
      Button,
      {
        size: "sm",
        onClick: async () => {
        ...
        children: loading ? /* @__PURE__ */ jsx25(LoaderCircle, { className: "au-w-4 au-h-4 au-animate-spin" }) : /* @__PURE__ */ jsx25(Fragment7, { children: /* @__PURE__ */ jsx25("span", { className: "au-whitespace-nowrap au-flex au-gap-1", children: "Confirm" }) })
      }
    ) })
  ] }) });
}
function PriceInformation({
  ...
  return /* @__PURE__ */ jsxs6("div", { className: "au-px-6 au-mb-4 au-flex au-flex-col au-gap-4", children: [
    ...
    /* @__PURE__ */ jsxs6("div", { className: "au-flex au-flex-col au-gap-2", children: [
      checkoutResult?.has_prorations && checkoutResult.lines.length > 0 && /* @__PURE__ */ jsx25(CheckoutLines, { checkoutResult }),
      /* @__PURE__ */ jsx25(DueAmounts, { checkoutResult })
    ] })
  ] });
}
function DueAmounts({ checkoutResult }) {
  ...
  return /* @__PURE__ */ jsxs6("div", { className: "au-flex au-flex-col au-gap-1", children: [
    /* @__PURE__ */ jsxs6("div", { className: "au-flex au-justify-between", children: [
      /* @__PURE__ */ jsx25("div", { children: /* @__PURE__ */ jsx25("p", { className: "au-font-medium au-text-md", children: "Total due today" }) }),
      /* @__PURE__ */ jsx25("p", { className: "au-font-medium au-text-md", children: formatCurrency({
    ...
    showNextCycle && /* @__PURE__ */ jsxs6("div", { className: "au-flex au-justify-between au-text-muted-foreground", children: [
      /* @__PURE__ */ jsx25("div", { children: /* @__PURE__ */ jsxs6("p", { className: "au-text-md", children: [
        "Due next cycle (",
        nextCycleAtStr,
        ")"
      ] }) }),
      /* @__PURE__ */ jsxs6("p", { className: "au-text-md", children: [
        ...
        hasUsagePrice && /* @__PURE__ */ jsx25("span", { children: " + usage prices" })
      ] })
    ] })
  ] });
}
function ProductItems({
  ...
  return /* @__PURE__ */ jsxs6("div", { className: "au-flex au-flex-col au-gap-2", children: [
    /* @__PURE__ */ jsx25("p", { className: "au-text-sm au-font-medium", children: "Price" }),
    checkoutResult?.product.items.filter((item) => item.type !== "feature").map((item, index2) => {
      ...
      return /* @__PURE__ */ jsxs6("div", { className: "au-flex au-justify-between", children: [
        /* @__PURE__ */ jsx25("p", { className: "au-text-muted-foreground", children: item.feature ? item.feature.name : isOneOff ? "Price" : "Subscription" }),
...
function CheckoutLines({ checkoutResult }) {
  return /* @__PURE__ */ jsx25(Accordion2, { type: "single", collapsible: true, children: /* @__PURE__ */ jsxs6(AccordionItem2, { value: "total", className: "au-border-b-0", children: [
    /* @__PURE__ */ jsx25(CustomAccordionTrigger, { className: "au-justify-between au-w-full au-my-0 au-py-0 au-border-none", children: /* @__PURE__ */ jsxs6("div", { className: "au-cursor-pointer au-flex au-items-center au-gap-1 au-w-full au-justify-end", children: [
      /* @__PURE__ */ jsx25("p", { className: "au-font-light au-text-muted-foreground", children: "View details" }),
      /* @__PURE__ */ jsx25(
        ChevronDown,
        {
    ...
    /* @__PURE__ */ jsx25(AccordionContent2, { className: "au-mt-2 au-mb-0 au-pb-2 au-flex au-flex-col au-gap-2", children: checkoutResult?.lines.filter((line) => line.amount !== 0).map((line, index2) => {
      return /* @__PURE__ */ jsxs6("div", { className: "au-flex au-justify-between", children: [
        /* @__PURE__ */ jsx25("p", { className: "au-text-muted-foreground", children: line.description }),
        /* @__PURE__ */ jsx25("p", { className: "au-text-muted-foreground", children: new Intl.NumberFormat("en-US", {
          style: "currency",
          currency: checkoutResult?.currency
        }).format(line.amount) })
      ] }, index2);
...
function CustomAccordionTrigger({
  ...
  return /* @__PURE__ */ jsx25(Header, { className: "au-flex", children: /* @__PURE__ */ jsx25(
    Trigger2,
    {
...
var PrepaidItem = ({
  ...
  return /* @__PURE__ */ jsxs6("div", { className: "au-flex au-justify-between au-gap-2", children: [
    /* @__PURE__ */ jsxs6("div", { className: "au-flex au-gap-2 au-items-start", children: [
      /* @__PURE__ */ jsx25("p", { className: "au-text-muted-foreground au-whitespace-nowrap", children: item.feature?.name }),
        ...
        /* @__PURE__ */ jsxs6(
          PopoverTrigger2,
          {
            ...
            children: [
              "Qty: ",
              quantity,
              !disableSelection && /* @__PURE__ */ jsx25(ChevronDown, { size: 12 })
            ]
          }
        ),
        /* @__PURE__ */ jsxs6(
          PopoverContent2,
          {
            ...
            children: [
              /* @__PURE__ */ jsxs6("div", { className: "au-flex au-flex-col au-gap-1", children: [
                /* @__PURE__ */ jsx25("p", { className: "au-text-sm au-font-medium", children: item.feature?.name }),
              ...
              /* @__PURE__ */ jsxs6("div", { className: "au-flex au-justify-between au-items-end", children: [
                ...
                /* @__PURE__ */ jsx25(
                  Button,
                  {
                    ...
                    disabled: loading,
                    children: loading ? /* @__PURE__ */ jsx25(LoaderCircle, { className: "au-text-muted-foreground au-animate-spin !au-w-4 !au-h-4" }) : "Save"
                  }
                )
              ] })
            ]
...
import { Fragment as Fragment8, jsx as jsx26, jsxs as jsxs7 } from "react/jsx-runtime";
function PaywallDialog(params) {
  ...
  if (!params || !preview) {
    return /* @__PURE__ */ jsx26(Fragment8, {});
  }
  const { open, setOpen } = params;
  const { title, message } = getPaywallContent(preview);
  return /* @__PURE__ */ jsx26(Dialog2, { open, onOpenChange: setOpen, children: /* @__PURE__ */ jsxs7(DialogContent2, { className: "au-p-0 au-pt-4 au-gap-0 au-text-foreground au-overflow-hidden au-text-sm", children: [
    /* @__PURE__ */ jsx26(DialogTitle2, { className: cn("au-font-bold au-text-xl au-px-6"), children: title }),
    /* @__PURE__ */ jsx26("div", { className: "au-px-6 au-my-2", children: message }),
    /* @__PURE__ */ jsx26(DialogFooter, { className: "au-flex au-flex-col sm:au-flex-row au-justify-between au-gap-x-4 au-py-2 au-mt-4 au-pl-6 au-pr-3 au-bg-secondary au-border-t", children: /* @__PURE__ */ jsx26(
      Button,
      {
        size: "sm",
...
var Switch2 = React43.forwardRef(({ className, ...props }, ref) => /* @__PURE__ */ jsx28(
  Root5,
  {
    className: cn(
...
var getPricingTableContent = (product) => {
  ...
  if (has_trial) {
    return {
      buttonText: /* @__PURE__ */ jsx29("p", { children: "Start Free Trial" })
    };
  }
  switch (scenario) {
    case "scheduled":
      return {
        buttonText: /* @__PURE__ */ jsx29("p", { children: "Plan Scheduled" })
      };
    case "active":
      if (updateable) {
        return {
          buttonText: /* @__PURE__ */ jsx29("p", { children: "Update Plan" })
        };
      }
      return {
        buttonText: /* @__PURE__ */ jsx29("p", { children: "Current Plan" })
      };
    case "new":
      if (is_one_off) {
        return {
          buttonText: /* @__PURE__ */ jsx29("p", { children: "Purchase" })
        };
      }
      return {
        buttonText: /* @__PURE__ */ jsx29("p", { children: "Get started" })
      };
    case "renew":
      return {
        buttonText: /* @__PURE__ */ jsx29("p", { children: "Renew" })
      };
    case "upgrade":
      return {
        buttonText: /* @__PURE__ */ jsx29("p", { children: "Upgrade" })
      };
    case "downgrade":
      return {
        buttonText: /* @__PURE__ */ jsx29("p", { children: "Downgrade" })
      };
    case "cancel":
      return {
        buttonText: /* @__PURE__ */ jsx29("p", { children: "Cancel Plan" })
      };
    default:
      return {
        buttonText: /* @__PURE__ */ jsx29("p", { children: "Get Started" })
...
// src/libraries/react/components/pricing-table/pricing-table-synced.tsx
import { Fragment as Fragment9, jsx as jsx30, jsxs as jsxs9 } from "react/jsx-runtime";
function PricingTable({
  ...
  if (isLoading) {
    return /* @__PURE__ */ jsx30("div", { style: loadingStyles, children: /* @__PURE__ */ jsx30(LoaderCircle, { style: spinnerStyles }) });
  }
  if (error) {
    return /* @__PURE__ */ jsx30("div", { children: " Something went wrong..." });
  }
  ...
  return /* @__PURE__ */ jsx30("div", { className: cn("au-root"), children: products && /* @__PURE__ */ jsx30(
    PricingTableContainer,
    {
      ...
      multiInterval,
      children: products.filter(intervalFilter).map((product, index2) => /* @__PURE__ */ jsx30(
        PricingCard,
        {
...
var PricingCard = ({
  ...
  return /* @__PURE__ */ jsxs9(
    "div",
    {
      ...
      children: [
        productDisplay?.recommend_text && /* @__PURE__ */ jsx30(RecommendedBadge, { recommended: productDisplay?.recommend_text }),
        /* @__PURE__ */ jsxs9(
          "div",
          {
            className: cn(
              ...
              /* @__PURE__ */ jsxs9("div", { className: "au-h-full", children: [
                /* @__PURE__ */ jsxs9("div", { className: "au-flex au-flex-col", children: [
                  /* @__PURE__ */ jsxs9("div", { className: "au-pb-4", children: [
                    /* @__PURE__ */ jsx30("h2", { className: "au-text-2xl au-font-semibold au-px-6 au-truncate", children: productDisplay?.name || name }),
                    productDisplay?.description && /* @__PURE__ */ jsx30("div", { className: "au-text-sm au-text-muted-foreground au-px-6 au-h-8", children: /* @__PURE__ */ jsx30("p", { className: "au-line-clamp-2", children: productDisplay?.description }) })
                  ] }),
                  /* @__PURE__ */ jsx30("div", { className: "au-mb-2", children: /* @__PURE__ */ jsx30("h3", { className: "au-font-semibold au-h-16 au-flex au-px-6 au-items-center au-border-y au-mb-4 au-bg-secondary/40", children: /* @__PURE__ */ jsxs9("div", { className: "au-line-clamp-2", children: [
                    mainPriceDisplay?.primary_text,
                    " ",
                    mainPriceDisplay?.secondary_text && /* @__PURE__ */ jsx30("span", { className: "au-font-normal au-text-muted-foreground au-mt-1", children: mainPriceDisplay?.secondary_text })
                  ] }) }) })
                ] }),
                showFeatures && featureItems.length > 0 && /* @__PURE__ */ jsx30("div", { className: "au-flex-grow au-px-6 au-mb-6", children: /* @__PURE__ */ jsx30(
                  PricingFeatureList,
                  {
                    items: featureItems,
...
var PricingFeatureList = ({
  ...
  return /* @__PURE__ */ jsxs9("div", { className: cn("au-flex-grow", className), children: [
    ...
    /* @__PURE__ */ jsx30("div", { className: "au-space-y-3", children: items.map((item, index2) => /* @__PURE__ */ jsx30(
      "div",
      {
        className: "au-flex au-items-start au-gap-2 au-text-sm",
        children: /* @__PURE__ */ jsxs9("div", { className: "au-flex au-flex-col", children: [
          /* @__PURE__ */ jsx30("span", { children: item.display?.primary_text }),
          item.display?.secondary_text && /* @__PURE__ */ jsx30("span", { className: "au-text-sm au-text-muted-foreground", children: item.display?.secondary_text })
        ] })
      },
      index2
    )) })
...
var PricingCardButton = React44.forwardRef(({ recommended, children, className, onClick, ...props }, ref) => {
  ...
  return /* @__PURE__ */ jsx30(
    Button,
    {
      ...
      onClick: handleClick,
      children: loading ? /* @__PURE__ */ jsx30(LoaderCircle, { className: "au-h-4 au-w-4 au-animate-spin" }) : /* @__PURE__ */ jsxs9(Fragment9, { children: [
        /* @__PURE__ */ jsxs9("div", { className: "au-flex au-items-center au-justify-between au-w-full au-transition-transform au-duration-300 group-hover:au-translate-y-[-130%]", children: [
          ...
          /* @__PURE__ */ jsx30("span", { className: "au-text-sm", children: "\u2192" })
        ] }),
...
var AnnualSwitch = ({
  ...
  return /* @__PURE__ */ jsxs9("div", { className: "au-flex au-items-center au-space-x-2 au-mb-4", children: [
    /* @__PURE__ */ jsx30("span", { className: "au-text-sm au-text-muted-foreground", children: "Monthly" }),
    /* @__PURE__ */ jsx30(
      Switch2,
      {
        id: "annual-billing",
    ...
    /* @__PURE__ */ jsx30("span", { className: "au-text-sm au-text-muted-foreground", children: "Annual" })
  ] });
};
var RecommendedBadge = ({ recommended }) => {
  return /* @__PURE__ */ jsx30("div", { className: "au-bg-secondary au-absolute au-border au-text-muted-foreground au-text-sm au-font-medium lg:au-rounded-full au-px-3 lg:au-py-0.5 lg:au-top-4 lg:au-right-4 au-top-[-1px] au-right-[-1px] au-rounded-bl-lg", children: recommended });
};

...
var PopoverContentModal = React39.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(Combination_default, { as: Slot3, allowPinchZoom: true, children: /* @__PURE__ */ (0, import_jsx_runtime20.jsx)(
      PopoverContentImpl,
      {
        ...props,
        ref: composedRefs,
...
var PopoverContent2 = React40.forwardRef(({ className, align = "center", sideOffset = 4, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(
  Content22,
  {
    ref,
    align,
...
var getCheckoutContent = (checkoutResult) => {
  ...
  if (is_one_off) {
    return {
      title: /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)("p", { children: [
        "Purchase ",
        productName
      ] }),
      message: /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)("p", { children: [
  ...
  if (scenario == "active" && updateable) {
    if (updateable) {
      return {
        title: /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("p", { children: "Update Plan" }),
        message: /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("p", { children: "Update your prepaid quantity. You'll be charged or credited the prorated difference based on your current billing cycle." })
      };
    }
  }
  if (has_trial) {
  ...
  switch (scenario) {
    ...
    case "active":
      return {
        title: /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("p", { children: "Product already active" }),
        message: /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("p", { children: "You are already subscribed to this product." })
      };
    case "new":
      if (is_free) {
        return {
    ...
    case "renew":
      return {
        title: /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("p", { children: "Renew" }),
        message: /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)("p", { children: [
    ...
    case "cancel":
      return {
        title: /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("p", { children: "Cancel" }),
        message: /* @__PURE__ */ (0, import_jsx_runtime29.jsxs)("p", { children: [
    ...
    default:
      return {
        title: /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("p", { children: "Change Subscription" }),
        message: /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("p", { children: "You are about to change your subscription." })
      };
  }
};
...
function CheckoutDialog(params) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime30.jsx)(Dialog2, { open, onOpenChange: setOpen, children: /* @__PURE__ */ (0, import_jsx_runtime30.jsxs)(DialogContent2, { className: "au-p-0 au-pt-4 au-gap-0 au-text-foreground au-text-sm", children: [
    /* @__PURE__ */ (0, import_jsx_runtime30.jsx)(DialogTitle2, { className: "au-px-6 au-mb-1", children: title }),
    /* @__PURE__ */ (0, import_jsx_runtime30.jsx)("div", { className: "au-px-6 au-mt-1 au-mb-4 au-text-muted-foreground", children: message }),
    isPaid && checkoutResult && /* @__PURE__ */ (0, import_jsx_runtime30.jsx)(
      PriceInformation,
      {
        checkoutResult,
        setCheckoutResult
    ...
    /* @__PURE__ */ (0, import_jsx_runtime30.jsx)(DialogFooter, { className: "au-flex au-flex-col sm:au-flex-row au-justify-between au-gap-x-4 au-py-2 au-pl-6 au-pr-3 au-bg-secondary au-border-t au-shadow-inner", children: /* @__PURE__ */ (0, import_jsx_runtime30.jsx)(
      Button,
      {
        size: "sm",
        onClick: async () => {
        ...
        children: loading ? /* @__PURE__ */ (0, import_jsx_runtime30.jsx)(LoaderCircle, { className: "au-w-4 au-h-4 au-animate-spin" }) : /* @__PURE__ */ (0, import_jsx_runtime30.jsx)(import_jsx_runtime30.Fragment, { children: /* @__PURE__ */ (0, import_jsx_runtime30.jsx)("span", { className: "au-whitespace-nowrap au-flex au-gap-1", children: "Confirm" }) })
      }
    ) })
  ] }) });
}
function PriceInformation({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime30.jsxs)("div", { className: "au-px-6 au-mb-4 au-flex au-flex-col au-gap-4", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime30.jsxs)("div", { className: "au-flex au-flex-col au-gap-2", children: [
      checkoutResult?.has_prorations && checkoutResult.lines.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime30.jsx)(CheckoutLines, { checkoutResult }),
      /* @__PURE__ */ (0, import_jsx_runtime30.jsx)(DueAmounts, { checkoutResult })
    ] })
  ] });
}
function DueAmounts({ checkoutResult }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime30.jsxs)("div", { className: "au-flex au-flex-col au-gap-1", children: [
    /* @__PURE__ */ (0, import_jsx_runtime30.jsxs)("div", { className: "au-flex au-justify-between", children: [
      /* @__PURE__ */ (0, import_jsx_runtime30.jsx)("div", { children: /* @__PURE__ */ (0, import_jsx_runtime30.jsx)("p", { className: "au-font-medium au-text-md", children: "Total due today" }) }),
      /* @__PURE__ */ (0, import_jsx_runtime30.jsx)("p", { className: "au-font-medium au-text-md", children: formatCurrency({
        amount: checkoutResult?.total,
        currency: checkoutResult?.currency
      }) })
    ] }),
    showNextCycle && /* @__PURE__ */ (0, import_jsx_runtime30.jsxs)("div", { className: "au-flex au-justify-between au-text-muted-foreground", children: [
      /* @__PURE__ */ (0, import_jsx_runtime30.jsx)("div", { children: /* @__PURE__ */ (0, import_jsx_runtime30.jsxs)("p", { className: "au-text-md", children: [
        "Due next cycle (",
        nextCycleAtStr,
        ")"
      ] }) }),
      /* @__PURE__ */ (0, import_jsx_runtime30.jsxs)("p", { className: "au-text-md", children: [
        formatCurrency({
          amount: next_cycle.total,
          currency: checkoutResult?.currency
        }),
        hasUsagePrice && /* @__PURE__ */ (0, import_jsx_runtime30.jsx)("span", { children: " + usage prices" })
      ] })
    ] })
  ] });
}
function ProductItems({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime30.jsxs)("div", { className: "au-flex au-flex-col au-gap-2", children: [
    /* @__PURE__ */ (0, import_jsx_runtime30.jsx)("p", { className: "au-text-sm au-font-medium", children: "Price" }),
    checkoutResult?.product.items.filter((item) => item.type !== "feature").map((item, index2) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime30.jsxs)("div", { className: "au-flex au-justify-between", children: [
        /* @__PURE__ */ (0, import_jsx_runtime30.jsx)("p", { className: "au-text-muted-foreground", children: item.feature ? item.feature.name : isOneOff ? "Price" : "Subscription" }),
...
function CheckoutLines({ checkoutResult }) {
  return /* @__PURE__ */ (0, import_jsx_runtime30.jsx)(Accordion2, { type: "single", collapsible: true, children: /* @__PURE__ */ (0, import_jsx_runtime30.jsxs)(AccordionItem2, { value: "total", className: "au-border-b-0", children: [
    /* @__PURE__ */ (0, import_jsx_runtime30.jsx)(CustomAccordionTrigger, { className: "au-justify-between au-w-full au-my-0 au-py-0 au-border-none", children: /* @__PURE__ */ (0, import_jsx_runtime30.jsxs)("div", { className: "au-cursor-pointer au-flex au-items-center au-gap-1 au-w-full au-justify-end", children: [
      /* @__PURE__ */ (0, import_jsx_runtime30.jsx)("p", { className: "au-font-light au-text-muted-foreground", children: "View details" }),
      /* @__PURE__ */ (0, import_jsx_runtime30.jsx)(
        ChevronDown,
        {
    ...
    /* @__PURE__ */ (0, import_jsx_runtime30.jsx)(AccordionContent2, { className: "au-mt-2 au-mb-0 au-pb-2 au-flex au-flex-col au-gap-2", children: checkoutResult?.lines.filter((line) => line.amount !== 0).map((line, index2) => {
      return /* @__PURE__ */ (0, import_jsx_runtime30.jsxs)("div", { className: "au-flex au-justify-between", children: [
        /* @__PURE__ */ (0, import_jsx_runtime30.jsx)("p", { className: "au-text-muted-foreground", children: line.description }),
        /* @__PURE__ */ (0, import_jsx_runtime30.jsx)("p", { className: "au-text-muted-foreground", children: new Intl.NumberFormat("en-US", {
          style: "currency",
          currency: checkoutResult?.currency
        }).format(line.amount) })
      ] }, index2);
...
function CustomAccordionTrigger({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime30.jsx)(Header, { className: "au-flex", children: /* @__PURE__ */ (0, import_jsx_runtime30.jsx)(
    Trigger2,
    {
...
var PrepaidItem = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime30.jsxs)("div", { className: "au-flex au-justify-between au-gap-2", children: [
    /* @__PURE__ */ (0, import_jsx_runtime30.jsxs)("div", { className: "au-flex au-gap-2 au-items-start", children: [
      /* @__PURE__ */ (0, import_jsx_runtime30.jsx)("p", { className: "au-text-muted-foreground au-whitespace-nowrap", children: item.feature?.name }),
      /* @__PURE__ */ (0, import_jsx_runtime30.jsxs)(Popover2, { open, onOpenChange: setOpen, children: [
        /* @__PURE__ */ (0, import_jsx_runtime30.jsxs)(
          PopoverTrigger2,
          {
            ...
            children: [
              "Qty: ",
              quantity,
              !disableSelection && /* @__PURE__ */ (0, import_jsx_runtime30.jsx)(ChevronDown, { size: 12 })
            ]
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime30.jsxs)(
          PopoverContent2,
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime30.jsxs)("div", { className: "au-flex au-flex-col au-gap-1", children: [
                /* @__PURE__ */ (0, import_jsx_runtime30.jsx)("p", { className: "au-text-sm au-font-medium", children: item.feature?.name }),
                /* @__PURE__ */ (0, import_jsx_runtime30.jsxs)("p", { className: "au-text-muted-foreground", children: [
                  item.display?.primary_text,
                  " ",
                  item.display?.secondary_text
                ] })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime30.jsxs)("div", { className: "au-flex au-justify-between au-items-end", children: [
                /* @__PURE__ */ (0, import_jsx_runtime30.jsxs)("div", { className: "au-flex au-gap-2 au-items-center", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime30.jsx)(
                    Input,
                    {
                ...
                /* @__PURE__ */ (0, import_jsx_runtime30.jsx)(
                  Button,
                  {
                    ...
                    disabled: loading,
                    children: loading ? /* @__PURE__ */ (0, import_jsx_runtime30.jsx)(LoaderCircle, { className: "au-text-muted-foreground au-animate-spin !au-w-4 !au-h-4" }) : "Save"
                  }
                )
              ] })
            ]
    ...
    /* @__PURE__ */ (0, import_jsx_runtime30.jsxs)("p", { className: "au-text-end", children: [
      item.display?.primary_text,
      " ",
      item.display?.secondary_text
    ] })
...
var PricingDialogButton = ({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime30.jsxs)(
    Button,
    {
      ...
      children: [
        children,
        /* @__PURE__ */ (0, import_jsx_runtime30.jsx)(ArrowRight, { className: "!au-h-3" })
      ]
    }
  );
};

  ...
  if (!analytics.hasData) {
    return (
      ...
      >
        ...
        <h3 className="text-xl font-bold text-white mb-2">No A/B Testing Data Yet</h3>
      ...
      >
        <div className="flex items-start justify-between mb-4">
          ...
          <div className="text-right">
            ...
            <div className="text-xs text-slate-400">Overall Interview Rate</div>
          </div>
        </div>

        <div className="grid grid-cols-3 gap-4">
          <div className="bg-slate-800/50 rounded-lg p-4">
            <div className="text-sm text-slate-400 mb-1">Total Applications</div>
            <div className="text-2xl font-bold text-white">
              {analytics.totalApplications}
            </div>
          </div>
          <div className="bg-slate-800/50 rounded-lg p-4">
            <div className="text-sm text-slate-400 mb-1">CV Versions Tested</div>
            <div className="text-2xl font-bold text-white">
              {analytics.versions.length}
            </div>
          </div>
          <div className="bg-slate-800/50 rounded-lg p-4">
            <div className="text-sm text-slate-400 mb-1">Best Version</div>
              ...
              >
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        <h5 className="text-white font-bold">{version.versionName}</h5>
                        {isWinner && (
                ...
                <div className="grid grid-cols-4 gap-3">
                  ...
                  <div className="bg-slate-900/50 rounded p-2">
                    ...
                    <div className="text-lg font-bold text-white">{version.offers}</div>
                  </div>
                  <div className="bg-slate-900/50 rounded p-2">

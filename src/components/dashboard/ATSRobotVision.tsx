...
export function ATSRobotVision() {
  ...
  return (
    <div className="h-full flex flex-col bg-[#F8FAFC] text-[#0F172A]">
      {/* Glassmorphic Header */}
      <header className="glass-panel border-b border-[#E2E8F0]/50 px-6 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-6">
          {/* Robot Vision Toggle */}
          <div className="flex items-center gap-3 px-4 py-2 rounded-lg bg-[#F8FAFC]/50 border border-[#E2E8F0]/50">
          ...
          <Button
            variant="outline"
            size="sm"
            className="border-[#E2E8F0] hover:bg-[#F8FAFC]/50 text-[#0F172A]"
          >
          ...
          <Button
            size="sm"
            className="bg-gradient-to-r from-[#3B82F6] to-[#8B5CF6] hover:opacity-90 text-[#0F172A]"
          >
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="flex-1 relative bg-[#FFFFFF]/50 p-8 overflow-auto custom-scrollbar">
          <div className="max-w-3xl mx-auto relative">
            ...
            <div className="relative bg-[#FFFFFF] rounded-lg shadow-2xl overflow-hidden min-h-[800px]">
              ...
              {/* Resume Content */}
              <div className="relative p-12 bg-[#FFFFFF] text-black">
                {/* Header Section Bounding Box */}
                <div className="relative border-2 border-green-500 rounded p-4 mb-6">
                  <div className="absolute -top-3 left-2 bg-[#22C55E] text-[#0F172A] text-xs font-bold px-2 py-1 rounded">
                    HEADER ✓
                  </div>
                ...
                <div className="relative border-2 border-[#3B82F6]/50 rounded p-4 mb-6">
                  <div className="absolute -top-3 left-2 bg-[#3B82F6] text-[#0F172A] text-xs font-bold px-2 py-1 rounded">
                    PARSED CONTENT
                  </div>
                ...
                {latestResume.hasImageTrap && (
                  <div className="relative border-2 border-red-500 rounded p-4 pulse-error mt-6">
                    <div className="absolute -top-3 left-2 bg-[#EF4444] text-[#0F172A] text-xs font-bold px-2 py-1 rounded animate-pulse">
                      IMAGE TRAP ⚠
                    </div>
            ...
            {/* Floating Toolbar */}
            <div className="fixed bottom-8 left-1/2 -translate-x-1/2 glass-panel px-6 py-3 rounded-full border border-[#E2E8F0]/50 flex items-center gap-4 shadow-2xl">
              <Button
                variant="ghost"
                size="sm"
                className="text-[#0F172A] hover:bg-slate-700/50"
                onClick={() => {}}
              >
        ...
        <div className="w-96 glass-panel border-l border-[#E2E8F0]/50 flex flex-col">
          {/* Inspector Header */}
          <div className="px-6 py-4 border-b border-[#E2E8F0]/50">
          ...
          <div className="flex-1 overflow-auto custom-scrollbar p-6 space-y-6">
            ...
            <div className="space-y-2">
              <h3 className="text-sm font-bold text-[#475569] flex items-center gap-2">
                <span className="material-symbols-outlined text-[16px]">terminal</span>
                Console Output
              </h3>
              <div className="bg-slate-950/50 rounded-lg p-3 font-mono text-xs space-y-1 border border-[#E2E8F0]">
            ...
            <div className="space-y-3">
              ...
              {/* Contact Block */}
              <div className="bg-[#F8FAFC]/30 rounded-lg p-3 border border-green-500/30">
              ...
              {latestResume.hasImageTrap && (
                <div className="bg-[#F8FAFC]/30 rounded-lg p-3 border border-red-500/30">
                  <div className="flex items-center justify-between mb-2">
            ...
            <div className="space-y-2">
              ...
              <div className="bg-slate-950/50 rounded-lg p-3 font-mono text-xs border border-[#E2E8F0] overflow-x-auto custom-scrollbar">
                <pre className="text-[#64748B]">{JSON.stringify({
                  id: latestResume._id,

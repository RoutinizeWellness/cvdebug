...
export function ATSScoreCard({ score, showDetails = true }: ATSScoreCardProps) {
  ...
  const getScoreStatus = () => {
    if (score >= 80) return { label: "High Match", color: "text-[#22C55E]", bg: "bg-[#22C55E]/10", border: "border-green-500/20" };
    if (score >= 50) return { label: "Medium Match", color: "text-[#F59E0B]", bg: "bg-yellow-500/10", border: "border-yellow-500/20" };
    return { label: "Low Match", color: "text-[#EF4444]", bg: "bg-[#EF4444]/10", border: "border-red-500/20" };
  };
  ...
  return (
    <div className="glass-card rounded-xl p-6 relative overflow-hidden group">
      ...
      <div className="flex flex-col items-center justify-center relative z-10">
        <h3 className="text-sm uppercase tracking-widest text-[#64748B] font-semibold mb-6">
        ...
        >
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            <motion.span
              ...
              className="text-5xl font-black text-[#0F172A] tracking-tighter drop-shadow-lg"
            >
              {score}%
            </motion.span>
            <motion.span
        ...
        {showDetails && (
          ...
          >
            ...
            <div className="flex justify-between text-[10px] text-[#64748B] mt-1 font-mono uppercase">
              <span>Reject</span>
              <span>Review</span>
              <span>Interview</span>
            </div>

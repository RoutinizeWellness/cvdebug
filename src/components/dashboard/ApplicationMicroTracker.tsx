    ...
    >
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h3 className="text-[#0F172A] font-bold text-base">Application Tracker</h3>
        ...
        <div className="flex items-center gap-4">
          ...
          {successRate > 0 && (
            <div className="flex items-center gap-1 px-2 py-1 bg-[#22C55E]/10 text-[#22C55E] rounded-md text-xs font-semibold">
              ...
              >
                <div className="flex items-center gap-3 flex-1 min-w-0">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      <h4 className="text-sm font-semibold text-[#0F172A] truncate max-w-[200px]" title={app.jobTitle || app.title}>
                    ...
                    <p className="text-xs text-[#64748B] truncate max-w-[250px]">{app.company || 'Company'}</p>
                  </div>
                </div>
      ...
      {/* Quick Stats Footer */}
      {totalApplications > 0 && (
        <div className="mt-4 pt-4 border-t border-[#E2E8F0] flex items-center justify-between text-xs">
          <div className="flex items-center gap-4">
            <div>
          ...
          <button className="text-[#3B82F6] hover:text-[#8B5CF6] font-semibold transition-colors">
            View All →
          </button>
        </div>
      )}

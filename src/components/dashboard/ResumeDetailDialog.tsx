...
export function ResumeDetailDialog({ selectedResume, setSelectedResume, handleDelete }: ResumeDetailDialogProps) {
  ...
  const FreeTierView = () => {
    ...
    if (showBlurredPreview) {
      // Get first critical keyword to show as "free sample"
          ...
          <div className="relative">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center bg-background/95 backdrop-blur-sm">
              <div className="text-center space-y-6 p-8 max-w-md">
                ...
                {/* FREE SAMPLE - One Critical Error Revealed */}
                ...
                {/* Smart Blur - Show categories but hide solutions */}

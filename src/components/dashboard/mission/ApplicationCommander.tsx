          ...
          <TableBody>
            {!jobHistory || jobHistory.length === 0 ? (
              ...
              jobHistory.map((job: any, i: number) => (
                <TableRow key={job._id} className="border-zinc-800 hover:bg-zinc-900/30 transition-colors group cursor-pointer">
                  <TableCell>
                  ...
                  <TableCell className="text-center">
                    <div className="flex items-center justify-center gap-2">
                      <div className={`font-black text-lg ${getScoreColor(job.score || 0)}`}>
                        {job.score || 0}%
                      </div>
                    </div>
                  </TableCell>
                  <TableCell className="text-center">
                    <DropdownMenu>
                      <DropdownMenuTrigger asChild>
                        <Button variant="outline" size="sm" className="h-7 text-xs border-zinc-700 bg-zinc-800/50 text-zinc-300 hover:bg-zinc-800 hover:text-white">

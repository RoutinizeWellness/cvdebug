      ...
      <div className="relative">
        ...
        <div className="flex items-start justify-between mb-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-slate-400 text-sm">Keywords de alto impacto detectadas</p>
            </div>
          </div>
        </div>

        {/* Main Message */}
        <div className="bg-slate-900/80 rounded-xl p-5 mb-5 border border-amber-500/20">
        ...
        <div className="grid grid-cols-2 gap-4 mb-5">
          <div className="bg-slate-800/60 rounded-xl p-4 border border-slate-700">
            <p className="text-slate-400 text-xs mb-1">Score Actual</p>
            <p className="text-white text-3xl font-bold font-mono">{currentScore}</p>
          </div>
          <div className="bg-gradient-to-br from-emerald-500/20 to-cyan-500/20 rounded-xl p-4 border border-emerald-500/30 relative overflow-hidden">
            ...
            <p className="text-white text-3xl font-bold font-mono flex items-baseline gap-2">
              {potentialScore}
        ...
        <div className="bg-gradient-to-r from-amber-500/10 to-orange-500/10 rounded-lg p-4 mb-5 border border-amber-500/20">
          <p className="text-amber-200 text-sm font-medium text-center">
            🎯 Desbloquea las otras {lockedKeywordsCount} keywords con <span className="text-white font-bold">Sniper Mode</span> por solo <span className="text-amber-400 font-black text-lg">$4.99</span>
          </p>
        </div>
        ...
        <Button
          onClick={onUnlock}
          className="w-full h-14 text-lg font-bold bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700 text-white shadow-lg shadow-amber-500/30 hover:shadow-amber-500/50 transition-all rounded-xl"
        >
        ...
        <div className="mt-4 text-center">
          <p className="text-slate-400 text-xs">
            ⚡ <span className="text-white font-medium">1,847 usuarios</span> desbloquearon Sniper Mode este mes
          </p>
        </div>
      </div>
    </motion.div>

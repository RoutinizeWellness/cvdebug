    ...
    <div className="glass-panel p-6 rounded-xl border border-slate-200 bg-white/50 h-full flex flex-col">
      <div className="flex items-start justify-between mb-6 gap-4">
        <div className="flex items-start gap-3 flex-1 min-w-0">
          ...
          <div className="flex-1 min-w-0">
            <h3 className="text-xs font-medium text-slate-500 mb-1">Target Role</h3>
            <p className="text-base font-bold text-slate-900 break-words">{role || "General Professional"}</p>
          </div>
        </div>
      ...
      <div className="space-y-4">
        <div className="space-y-2">
          ...
          <Progress value={matchScore} className="h-2 bg-slate-50" />
        </div>
        ...
        <div className="space-y-2">
          ...
          <Progress value={confidence} className="h-2 bg-slate-50" />
        </div>
      </div>

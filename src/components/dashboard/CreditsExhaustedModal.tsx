      ...
      {open && (
        <div className="fixed inset-0 z-[60] bg-midnight/70 backdrop-blur-md flex items-center justify-center p-4 transition-opacity duration-300">
          ...
          >
            ...
            <div className="bg-gradient-to-r from-teal-500/10 to-pink-500/10 border border-teal-500/30 rounded-xl p-4">
            ...
            <div className="px-6 py-4 border-t border-slate-800 flex gap-3 flex-col sm:flex-row">
              <button
                onClick={onUpgrade}
                className="flex-1 font-bold text-base h-12 bg-gradient-to-r from-teal-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 shadow-lg shadow-cyan-500/25 rounded-lg text-white flex items-center justify-center gap-2 transition-all"
              >

...
export function SkipLink({ targetId, label = 'Skip to main content' }: SkipLinkProps) {
  ...
  return (
    <a
      ...
      className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-50 focus:px-4 focus:py-2 focus:bg-[#0F172A] focus:text-white focus:rounded-lg focus:shadow-lg focus:outline-none focus:ring-2 focus:ring-[#475569] focus:ring-offset-2"
    >
      {label}
    </a>
  );

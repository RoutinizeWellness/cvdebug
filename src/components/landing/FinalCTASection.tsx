      ...
      >
        ...
        <div className="mt-10 flex flex-col items-center justify-center gap-y-6">
          <Button
            ...
            className="w-full max-w-md rounded-xl bg-gradient-to-r from-[#1E293B] to-[#64748B] px-8 py-4 text-lg font-bold text-white shadow-[0_10px_40px_-10px_rgba(100,116,139,0.5)] transition-all hover:scale-105 hover:from-[#1E293B] hover:to-[#64748B] border-0 sm:w-auto"
          >

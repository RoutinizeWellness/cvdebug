...
export function CTASection() {
  ...
  return (
    <section className="py-16 md:py-24 container mx-auto px-6">
      <div className="bg-gradient-to-br from-primary via-primary to-slate-700 rounded-3xl p-8 md:p-16 text-center text-primary-foreground relative overflow-hidden shadow-2xl shadow-primary/30">

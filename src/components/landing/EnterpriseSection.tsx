  ...
  return (
    <section className="py-24 relative" id="enterprise">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="glass-card rounded-2xl p-8 md:p-12 lg:p-16 relative overflow-hidden border-purple-500/20">
            ...
            <div>
              ...
              >
                <Button
                  ...
                  className="group relative inline-flex items-center justify-center overflow-hidden rounded-lg bg-gradient-to-r from-purple-600 to-pink-600 px-6 py-3 text-white font-semibold shadow-lg shadow-purple-500/25 hover:shadow-purple-500/40 hover:scale-[1.02] transition-all"
                >

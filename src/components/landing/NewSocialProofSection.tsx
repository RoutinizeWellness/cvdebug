      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="bg-white border-2 border-[#FF4500]/20 rounded-2xl p-8 shadow-lg">
            <div className="flex items-center justify-center gap-3 mb-6">
              ...
              <div>
                <h3 className="text-2xl font-black text-[#0F172A]">
                  Recomendado por las comunidades de Reddit
                </h3>
                <p className="text-sm text-[#475569] font-medium">
                  El ATS checker favorito de millones de job seekers
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
              {redditCommunities.map((community, index) => (
                ...
                >
                  ...
                  <p className="text-xs text-[#475569] font-medium mb-1">{community.members} members</p>
            ...
            <div className="text-center">
              <p className="text-sm text-[#475569] italic">
                "CVDebug es mencionado constantemente en las comunidades de búsqueda de empleo más activas de Reddit como la herramienta ATS más precisa y fácil de usar"
              </p>
            </div>
          </div>
        </motion.div>
        ...
        >
          <p className="text-sm font-medium text-[#475569] uppercase tracking-wider">
            Ingenieros de estas empresas usan CVDebug
          </p>
        </motion.div>

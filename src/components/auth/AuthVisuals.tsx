  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
        ...
        <div className="absolute top-0 left-0 w-[700px] h-[700px] bg-gradient-to-br from-primary/10 via-slate-500/8 to-transparent rounded-full blur-[120px] -translate-y-1/4 -translate-x-1/4"></div>

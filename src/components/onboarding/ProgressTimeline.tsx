...
export function ProgressTimeline({ currentStep }: ProgressTimelineProps) {
  ...
  return (
    <div className="hidden lg:flex flex-col gap-8 sticky top-24">
      <div className="bg-[#FFFFFF] border border-[#E2E8F0] p-6 rounded-2xl border-l-4 border-l-[#3B82F6] shadow-[0_10px_40px_-10px_rgba(0,0,0,0.08)]">
          ...
          {steps.map((step) => (
            <div key={step.number} className="flex gap-4">
              ...
              <div className="flex flex-col pt-1">
                ...
                <span className={`text-xs ${currentStep > step.number ? "text-[#64748B]" : currentStep === step.number ? "text-[#3B82F6]" : "text-[#64748B]"}`}>

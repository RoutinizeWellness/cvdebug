    ...
    switch (type) {
      case "success":
        return {
          ...
          iconBg: "bg-slate-600/10 border-slate-600/20 text-primary shadow-[0_0_15px_-3px_rgba(100,116,139,0.3)]",
          icon: CheckCircle,
          progressBar: "bg-primary shadow-[0_0_10px_2px_rgba(100,116,139,0.5)]",
      ...
      case "info":
        return {
          ...
          iconBg: "bg-secondary/10 border-secondary/20 text-secondary shadow-[0_0_15px_-3px_rgba(100,116,139,0.3)]",
          icon: Sparkles,
          progressBar: "bg-secondary shadow-[0_0_10px_2px_rgba(100,116,139,0.5)]",

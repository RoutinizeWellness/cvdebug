...
export const chat = action({
  ...
  handler: async (ctx, args) => {
    ...
    if (!hasActiveSprint && user?.subscriptionTier !== "interview_sprint") {
      throw new Error("PLAN_RESTRICTION: Upgrade to Career Sprint to use AI Chat.");
    }

...
export function planHas(tier?: string): {
  ...
  return {
    ...
    coverLetter: typeof features.coverLetterGenerator === 'boolean' ? features.coverLetterGenerator : true,
    linkedin: features.linkedinOptimizer || features.linkedinDeepAudit,

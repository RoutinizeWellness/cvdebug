...
export default function AuthPage() {
  ...
  const clerkAppearance = {
    elements: {
      ...
      formFieldInput: "block w-full pl-10 pr-3 py-3 bg-slate-900/80 border border-slate-700 rounded-lg text-white placeholder-slate-500 focus:outline-none focus:border-primary focus:ring-0 font-mono transition-all focus:shadow-[0_0_15px_rgba(59,130,246,0.3)]",
      ...
      socialButtonsBlockButton: "flex-1 flex items-center justify-center gap-2 h-11 rounded-lg bg-slate-800/50 hover:bg-slate-800 border border-slate-700 transition-all duration-200 text-sm font-medium text-slate-200 hover:text-white",
      ...
      otpCodeFieldInput: "bg-slate-900/80 border border-slate-700 text-white focus:border-primary focus:ring-0 rounded-lg",

          ...
          <div className="bg-[#FFFFFF] border border-[#E2E8F0] rounded-2xl p-8 md:p-12 space-y-8 shadow-[0_10px_40px_-10px_rgba(0,0,0,0.08)]">
            ...
            <section>
              ...
              <div className="space-y-4 text-[#475569] leading-relaxed">
                <p><strong className="text-[#0F172A]">Personal Information:</strong></p>
                ...
                <p className="mt-4"><strong className="text-[#0F172A]">Resume Data:</strong></p>
                <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <p className="mt-4"><strong className="text-[#0F172A]">Usage Data:</strong></p>
                <ul className="list-disc list-inside space-y-2 ml-4">
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2 text-[#475569] ml-4 mt-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-[#0F172A] mb-4">5. Data Sharing and Disclosure</h2>
              ...
              <ul className="list-disc list-inside space-y-2 text-[#475569] ml-4">
                <li><strong className="text-[#0F172A]">Service Providers:</strong> We work with trusted third-party services (e.g., cloud hosting, payment processing) who help us operate our service</li>
                <li><strong className="text-[#0F172A]">Legal Requirements:</strong> When required by law, court order, or to protect our rights</li>
                <li><strong className="text-[#0F172A]">Business Transfers:</strong> In connection with a merger, acquisition, or sale of assets</li>
                <li><strong className="text-[#0F172A]">With Your Consent:</strong> When you explicitly authorize us to share your information</li>
              </ul>
            </section>
            ...
            <section>
              <h2 className="text-2xl font-bold text-[#0F172A] mb-4">8. Cookies and Tracking</h2>
              <p className="text-[#475569] leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-[#0F172A] mb-4">9. Children's Privacy</h2>
              <p className="text-[#475569] leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-[#0F172A] mb-4">10. International Data Transfers</h2>
              <p className="text-[#475569] leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-[#0F172A] mb-4">11. Changes to This Policy</h2>
              <p className="text-[#475569] leading-relaxed">
            ...
            <section>
              ...
              <div className="mt-4 p-4 bg-[#F8FAFC] border border-[#E2E8F0] rounded-lg">
                <p className="text-[#0F172A]">Email: privacy@cvdebug.com</p>

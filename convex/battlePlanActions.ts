...
Return ONLY valid JSON in this format:
{
  ...
  "killerQuestion": {
    ...
    try {
      ...
      const battlePlanData = JSON.parse(content);
      ...
      return {
        ...
        battlePlan: {
          ...
          confidence: {
            matchScore: 82,
            strengths: battlePlanData.strategicPoints?.length || 0,
            gaps: battlePlanData.hardestQuestions?.length || 0,
            recommendation: "Generated by AI based on your specific resume and job description."
          }
        }
      };
    } catch (error: any) {
      ...
      return {
        ...
        confidence: {
          ...
          strengths: 5,
          gaps: 2,
          recommendation: "Fallback data - AI generation failed. Please check your API key configuration."
        }
        };
      }
    }

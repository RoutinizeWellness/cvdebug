#!/usr/bin/env python3
"""
Script to update i18n translations in src/lib/i18n.ts
This script updates the landing, onboarding, pricingPage, and modals sections
for all 10 locales with the correct translations from the reference document.
"""

import re

# Read the current i18n.ts file
with open('/home/daytona/codebase/src/lib/i18n.ts', 'r', encoding='utf-8') as f:
    content = f.read()

# EN-US translations (with $ currency)
...
en_us_pricing_page = """    pricingPage: {
      freePlan: {
        name: 'FREE Debug',
...
print("Ready to update translations...")
